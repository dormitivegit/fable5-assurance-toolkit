...
[GitHub private security advisories](https://github.com/dormitivegit/software-evidence-controls/security/advisories/new):
...
Software Evidence Controls `0.4.0-rename.1` has
